                            ...
                            <div class="main-content-wrap">
                                <div class="flex items-center flex-wrap justify-between gap20 mb-30">
                                    ...
                                    <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                                        ...
                                        <li>
                                            <a href="oder-detail.html#"><div class="text-tiny">Order</div></a>
                                        </li>
                                        <li>
                                            <i class="icon-chevron-right"></i>
                                        </li>
                                        <li>
                                            <a href="oder-detail.html#"><div class="text-tiny">Order detail</div></a>
                                        </li>
                                        <li>
                                            <i class="icon-chevron-right"></i>
                                        </li>
                                                    ...
                                                    <li class="wg-product">
                                                        <div class="name">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="title">
                                                                    <a href="oder-detail.html#" class="body-title-2">Ribbed Tank Top</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div>
                                                    ...
                                                    <li class="wg-product">
                                                        <div class="name">
                                                            ...
                                                            <div>
                                                                <div class="text-tiny">Product name</div>
                                                                <div class="title">
                                                                    <a href="oder-detail.html#" class="body-title-2">V-neck linen T-shirt</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div>
                                                    ...
                                                    <li class="wg-product">
                                                        <div class="name">
                                                            ...
                                                            <div>
                                                                <div class="text-tiny">Product name</div>
                                                                <div class="title">
                                                                    <a href="oder-detail.html#" class="body-title-2">Ribbed modal T-shirt</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div>
