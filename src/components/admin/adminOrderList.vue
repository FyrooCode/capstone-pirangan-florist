            ...
            <div class="main-content-wrap">
                ...
                <div class="wg-box">
                    <div class="flex items-center justify-between gap10 flex-wrap">
                        ...
                        <a class="tf-button style-1 w208" href="oder-detail.html"><i class="icon-file-text"></i>Export
                            all order</a>
                    </div>
                            ...
                            <li class="wg-product item-row gap20">
                                <div class="name">
                                    ...
                                    <div class="title line-clamp-2 mb-0">
                                        <a href="oder-list.html#" class="body-text fw-6">Oversized Motif T-shirt</a>
                                    </div>
                                </div>
                    ...
                    <div class="flex items-center justify-between flex-wrap gap10">
                        ...
                        <ul class="wg-pagination">
                            <li>
                                <a href="oder-list.html#"><i class="icon-chevron-left"></i></a>
                            </li>
                            <li>
                                <a href="oder-list.html#">1</a>
                            </li>
                            <li class="active">
                                <a href="oder-list.html#">2</a>
                            </li>
                            <li>
                                <a href="oder-list.html#">3</a>
                            </li>
                            <li>
                                <a href="oder-list.html#"><i class="icon-chevron-right"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
