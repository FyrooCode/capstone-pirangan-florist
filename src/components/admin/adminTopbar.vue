        ...
        <div class="wrap">
            <div class="header-left">
                <router-link to="/admin">
                    <img class="" id="logo_header_mobile" alt="Priangan Florist Admin"
                        src="/user/images/logo/priangan-florist.png" data-light="/user/images/logo/priangan-florist.png"
                        data-dark="/user/images/logo/priangan-florist.png">
                </router-link>
            ...
            <div class="header-grid">
                <div class="header-item country">
                    <select class="image-select no-text">
                        ...
                        <option data-thumbnail="/admin/images/country/9.png">IDN</option>
                    </select>
                </div>
                                ...
                                <div class="noti-item w-full wg-user active">
                                    ...
                                    <div class="flex-grow">
                                        <div class="flex items-center justify-between">
                                            <a href="index.html#" class="body-title">Cameron
                                                Williamson</a>
                ...
                <div class="popup-wrap user type-header">
                    <div class="dropdown">
                        <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton3"
                            ...
                            <span class="header-user wg-user">
                                ...
                                <span class="flex flex-column">
                                    <span class="body-text text-main-dark">Admin User</span>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton3">
                            ...
                            <li>
                                <router-link to="/login" class="user-item">
                                    <div class="icon">
...
onMounted(() => {
    ...
    setTimeout(() => {
        // Initialize dropdowns if jQuery and Bootstrap are available
        if (window.$ && window.bootstrap) {
            // Initialize bootstrap-select for dropdown menus
            if ($.fn.selectpicker) {
            ...
            if (dropdownToggleList.length > 0) {
                Array.from(dropdownToggleList).forEach(el => {
