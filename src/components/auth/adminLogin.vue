<template>
    ...
    <div id="page" class="">
        <div class="login-page">
                ...
                <div class="login-box">
                    ...
                    <form class="form-login flex flex-column gap22 w-full" action="index.html">
                        <fieldset class="email">
                            ...
                            <input class="flex-grow" type="email" placeholder="Enter your email address" name="email"
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <a href="login.html#" class="body-text tf-color">Forgot password?</a>
                        </div>
            ...
            <div class="right">
                <img src="/admin/images/images-section/Sign&#32;in.jpg" alt="">
            </div>
        </div>
    </div>
    <!-- /#page -->
