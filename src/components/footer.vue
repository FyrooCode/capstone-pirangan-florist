            ...
            <div class="col-xl-3 col-md-6 col-12">
              <div class="footer-col footer-col-3 footer-col-block">
                ...
                <ul class="footer-menu-list tf-collapse-content">
                  ...
                  <li>
                    <a href="home-plant.html#" class="footer-menu_item text-decoration-underline"
                      >See Our Stores</a
                    >
                  </li>
                  <li>
                  ...
                  <li>
                    <ul class="tf-social-icon d-flex gap-20 style-default style-white">
                      ...
                      <li>
                        <a
                          href="home-plant.html#"
                          class="box-icon round social-twiter border-line-black"
                          ><i class="icon fs-14 icon-Icon-x"></i
                        ></a>
                      </li>
                      <li>
                        <a
                      ...
                      <li>
                        <a
                          href="home-plant.html#"
                          class="box-icon round social-tiktok border-line-black"
                      ...
                      <li>
                        <a
                          href="home-plant.html#"
                          class="box-icon round social-pinterest border-line-black"
                  ...
                  <div class="tf-cur">
                    <div class="tf-currencies">
                      <select class="image-select center style-default color-white type-currencies">
                        <option data-thumbnail="/user/images/country/fr.svg">
                          EUR <span>€ | France</span>
                        </option>
                        <option data-thumbnail="/user/images/country/de.svg">
                          EUR <span>€ | Germany</span>
                        </option>
                        <option selected data-thumbnail="/user/images/country/us.svg">
                          USD <span>$ | United States</span>
                        </option>
                        <option data-thumbnail="/user/images/country/vn.svg">
            ...
            <div class="demo-item">
              <a href="index.html">
                <div class="demo-image position-relative">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-01.jpg"
                    src="/user/images/demo/home-01.jpg"
                    alt="home-01"
                  />
            ...
            <div class="demo-item">
              <a href="home-multi-brand.html">
                <div class="demo-image position-relative">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-multi-brand.jpg"
                    src="/user/images/demo/home-multi-brand.jpg"
            ...
            <div class="demo-item">
              <a href="home-02.html">
                <div class="demo-image position-relative">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-02.jpg"
                    src="/user/images/demo/home-02.jpg"
                    alt="home-02"
                  />
                  <div class="demo-label">
                    <span class="demo-hot">Hot</span>
            ...
            <div class="demo-item">
              <a href="home-03.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-03.jpg"
                    src="/user/images/demo/home-03.jpg"
                    alt="home-03"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-04.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-04.jpg"
                    src="/user/images/demo/home-04.jpg"
                    alt="home-04"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-05.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-05.jpg"
                    src="/user/images/demo/home-05.jpg"
                    alt="home-05"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-06.html">
                <div class="demo-image position-relative">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-06.jpg"
                    src="/user/images/demo/home-06.jpg"
                    alt="home-06"
                  />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
            ...
            <div class="demo-item position-relative">
              <a href="home-personalized-pod.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-personalized-pod.jpg"
                    src="/user/images/demo/home-personalized-pod.jpg"
            ...
            <div class="demo-item position-relative">
              <a href="home-pickleball.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-pickleball.png"
                    src="/user/images/demo/home-pickleball.png"
                    alt="home-pickleball"
                  />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
            ...
            <div class="demo-item position-relative">
              <a href="home-ceramic.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-ceramic.png"
                    src="/user/images/demo/home-ceramic.png"
                    alt="home-ceramic"
                  />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
            ...
            <div class="demo-item position-relative">
              <a href="home-food.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-food.png"
                    src="/user/images/demo/home-food.png"
                    alt="home-food"
                  />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
            ...
            <div class="demo-item position-relative">
              <a href="home-camp-and-hike.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-camp-and-hike.png"
                    src="/user/images/demo/home-camp-and-hike.png"
            ...
            <div class="demo-item">
              <a href="home-07.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-07.jpg"
                    src="/user/images/demo/home-07.jpg"
                    alt="home-07"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-08.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-08.jpg"
                    src="/user/images/demo/home-08.jpg"
                    alt="home-08"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-skincare.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-skincare.jpg"
                    src="/user/images/demo/home-skincare.jpg"
                    alt="home-skincare"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-headphone.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-headphone.jpg"
                    src="/user/images/demo/home-headphone.jpg"
                    alt="home-headphone"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-giftcard.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-giftcard.jpg"
                    src="/user/images/demo/home-giftcard.jpg"
                    alt="home-gift-card"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-furniture.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-furniture.jpg"
                    src="/user/images/demo/home-furniture.jpg"
                    alt="home-furniture"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-furniture-02.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-furniture2.jpg"
                    src="/user/images/demo/home-furniture2.jpg"
            ...
            <div class="demo-item">
              <a href="home-skateboard.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-skateboard.jpg"
                    src="/user/images/demo/home-skateboard.jpg"
                    alt="home-skateboard"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-stroller.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-stroller.jpg"
                    src="/user/images/demo/home-stroller.jpg"
                    alt="home-stroller"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-decor.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-decor.jpg"
                    src="/user/images/demo/home-decor.jpg"
                    alt="home-decor"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-electronic.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-electronic.jpg"
                    src="/user/images/demo/home-electronic.jpg"
                    alt="home-electronic"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-setup-gear.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-setup-gear.jpg"
                    src="/user/images/demo/home-setup-gear.jpg"
                    alt="home-setup-gear"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-dog-accessories.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-dog-accessories.jpg"
                    src="/user/images/demo/home-dog-accessories.jpg"
            ...
            <div class="demo-item">
              <a href="home-kitchen-wear.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-kitchen.jpg"
                    src="/user/images/demo/home-kitchen.jpg"
            ...
            <div class="demo-item">
              <a href="home-phonecase.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-phonecase.jpg"
                    src="/user/images/demo/home-phonecase.jpg"
                    alt="home-phonecase"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-paddle-boards.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home_paddle_board.jpg"
                    src="/user/images/demo/home_paddle_board.jpg"
            ...
            <div class="demo-item">
              <a href="home-glasses.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-glasses.jpg"
                    src="/user/images/demo/home-glasses.jpg"
                    alt="home-glasses"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-pod-store.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-pod-store.jpg"
                    src="/user/images/demo/home-pod-store.jpg"
                    alt="home-pod-store"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-activewear.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-activewear.jpg"
                    src="/user/images/demo/home-activewear.jpg"
                    alt="home-activewear"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-handbag.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-handbag.jpg"
                    src="/user/images/demo/home-handbag.jpg"
                    alt="home-handbag"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-tee.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-tee.jpg"
                    src="/user/images/demo/home-tee.jpg"
                    alt="home-tee"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-sock.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-socks.jpg"
                    src="/user/images/demo/home-socks.jpg"
                    alt="home-sock"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-jewerly.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-jewelry.jpg"
                    src="/user/images/demo/home-jewelry.jpg"
                    alt="home-jewelry"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-sneaker.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-sneaker.jpg"
                    src="/user/images/demo/home-sneaker.jpg"
                    alt="home-sneaker"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-accessories.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-accessories.jpg"
                    src="/user/images/demo/home-accessories.jpg"
            ...
            <div class="demo-item">
              <a href="home-grocery.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-gocery.jpg"
                    src="/user/images/demo/home-gocery.jpg"
                    alt="home-grocery"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-baby.html">
                <div class="demo-image">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-baby.jpg"
                    src="/user/images/demo/home-baby.jpg"
                    alt="home-baby"
                  />
                </div>
            ...
            <div class="demo-item">
              <a href="home-cosmetic.html">
                <div class="demo-image position-relative">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-cosmetic.png"
                    src="/user/images/demo/home-cosmetic.png"
                    alt="home-cosmetic"
                  />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
            ...
            <div class="demo-item">
              <a href="home-plant.html">
                <div class="demo-image position-relative">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-plant.png"
                    src="/user/images/demo/home-plant.png"
                    alt="home-plant"
                  />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
            ...
            <div class="demo-item">
              <a href="home-swimwear.html">
                <div class="demo-image position-relative">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-swimwear.png"
                    src="/user/images/demo/home-swimwear.png"
                    alt="home-swimwear"
                  />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
            ...
            <div class="demo-item">
              <a href="home-electric-bike.html">
                <div class="demo-image position-relative">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-electric-bike.png"
                    src="/user/images/demo/home-electric-bike.png"
            ...
            <div class="demo-item">
              <a href="home-footwear.html">
                <div class="demo-image position-relative">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-footwear.jpg"
                    src="/user/images/demo/home-footwear.jpg"
                    alt="home-footwear"
                  />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
            ...
            <div class="demo-item">
              <a href="home-book-store.html">
                <div class="demo-image position-relative">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-bookstore.png"
                    src="/user/images/demo/home-bookstore.png"
                    alt="home-bookstore"
                  />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
            ...
            <div class="demo-item">
              <a href="home-gaming-accessories.html">
                <div class="demo-image position-relative">
                  <img
                    class="lazyload"
                    data-src="/user/images/demo/home-gaming-accessories.png"
                    src="/user/images/demo/home-gaming-accessories.png"
      ...
      <div class="mb-body">
        <ul class="nav-ul-mb" id="wrapper-menu-navigation">
          <li class="nav-mb-item">
            <a
              href="index.html#dropdown-menu-one"
            ...
            <div id="dropdown-menu-one" class="collapse">
              <ul class="sub-nav-menu">
                ...
                <li>
                  <a href="home-personalized-pod.html" class="sub-nav-link"
                    >Home Personalized Pod</a
                  >
                </li>
                ...
                <li>
                  <a href="home-gaming-accessories.html" class="sub-nav-link"
                    >Home Gaming Accessories</a
                  >
                </li>
          ...
          <li class="nav-mb-item">
            <a
              href="index.html#dropdown-menu-two"
              class="collapsed mb-menu-link current"
              data-bs-toggle="collapse"
              aria-expanded="true"
            ...
            <div id="dropdown-menu-two" class="collapse">
              <ul class="sub-nav-menu" id="sub-menu-navigation">
                <li>
                  ...
                  <div id="sub-shop-one" class="collapse">
                    <ul class="sub-nav-menu sub-menu-level-2">
                      ...
                      <li>
                        <a href="shop-collection-list.html" class="sub-nav-link"
                          >Collections list</a
                        >
                      </li>
                    </ul>
                ...
                <li>
                  ...
                  <div id="sub-shop-two" class="collapse">
                    <ul class="sub-nav-menu sub-menu-level-2">
                      ...
                      <li>
                        <a href="shop-infinite-scrolling.html" class="sub-nav-link"
                ...
                <li>
                  <a
                    href="index.html#sub-shop-three"
                    class="sub-nav-link collapsed"
                    data-bs-toggle="collapse"
                    aria-expanded="true"
          ...
          <li class="nav-mb-item">
            <a
              href="index.html#dropdown-menu-three"
              class="collapsed mb-menu-link current"
              data-bs-toggle="collapse"
              aria-expanded="true"
            ...
            <div id="dropdown-menu-three" class="collapse">
              <ul class="sub-nav-menu" id="sub-menu-navigation">
                <li>
                  <a
                    href="index.html#sub-product-one"
                    class="sub-nav-link collapsed"
                    data-bs-toggle="collapse"
                    aria-expanded="true"
                  ...
                  <div id="sub-product-one" class="collapse">
                    <ul class="sub-nav-menu sub-menu-level-2">
                      ...
                      <li>
                        <a href="product-right-thumbnails.html" class="sub-nav-link"
                          >Product right thumbnails</a
                        >
                      </li>
                      <li>
                        <a href="product-bottom-thumbnails.html" class="sub-nav-link"
                          >Product bottom thumbnails</a
                        >
                      </li>
                      <li>
                        <a href="product-drawer-sidebar.html" class="sub-nav-link"
                          >Product drawer sidebar</a
                        >
                      </li>
                      <li>
                        <a href="product-description-accordion.html" class="sub-nav-link"
                          >Product description accordion</a
                        >
                      </li>
                      <li>
                        <a href="product-description-list.html" class="sub-nav-link"
                          >Product description list</a
                        >
                      </li>
                      <li>
                        <a href="product-description-vertical.html" class="sub-nav-link"
                ...
                <li>
                  <a
                    href="index.html#sub-product-two"
                    class="sub-nav-link collapsed"
                    data-bs-toggle="collapse"
                    aria-expanded="true"
                  ...
                  <div id="sub-product-two" class="collapse">
                    <ul class="sub-nav-menu sub-menu-level-2">
                      <li>
                        <a href="product-inner-zoom.html" class="sub-nav-link"
                          >Product inner zoom</a
                        >
                      </li>
                      <li>
                        <a href="product-zoom-magnifier.html" class="sub-nav-link"
                      ...
                      <li>
                        <a href="product-photoswipe-popup.html" class="sub-nav-link"
                          >Product photoswipe popup</a
                        >
                      </li>
                      <li>
                        <a href="product-zoom-popup.html" class="sub-nav-link"
                          >Product external zoom and photoswipe popup</a
                        >
                      </li>
                      ...
                      <li>
                        <a href="product-options-customizer.html" class="sub-nav-link"
                          >Product options & customizer</a
                        >
                      </li>
                      <li>
                        <a href="product-advanced-types.html" class="sub-nav-link"
                          >Advanced product types</a
                        >
                      </li>
                      <li>
                        <a href="product-giftcard.html" class="sub-nav-link"
                          >Recipient information form for gift card products</a
                        >
                      </li>
                    </ul>
                  </div>
                ...
                <li>
                  <a
                    href="index.html#sub-product-three"
                    class="sub-nav-link collapsed"
                    data-bs-toggle="collapse"
                    aria-expanded="true"
                  ...
                  <div id="sub-product-three" class="collapse">
                    <ul class="sub-nav-menu sub-menu-level-2">
                      <li>
                        <a href="product-color-swatch.html" class="sub-nav-link"
                      ...
                      <li>
                        <a href="product-rectangle-color.html" class="sub-nav-link"
                          >Product rectangle color</a
                        >
                      </li>
                      <li>
                        <a href="product-swatch-image.html" class="sub-nav-link"
                          >Product swatch image</a
                        >
                      </li>
                      <li>
                        <a href="product-swatch-image-rounded.html" class="sub-nav-link"
                          >Product swatch image rounded</a
                        >
                      </li>
                      <li>
                        <a href="product-swatch-dropdown.html" class="sub-nav-link"
                          >Product swatch dropdown</a
                        >
                      </li>
                      <li>
                        <a href="product-swatch-dropdown-color.html" class="sub-nav-link"
                ...
                <li>
                  <a
                    href="index.html#sub-product-four"
                    class="sub-nav-link collapsed"
                    data-bs-toggle="collapse"
                    aria-expanded="true"
                  ...
                  <div id="sub-product-four" class="collapse">
                    <ul class="sub-nav-menu sub-menu-level-2">
                      <li>
                        <a href="product-frequently-bought-together.html" class="sub-nav-link"
                          >Frequently bought together</a
                        >
                      </li>
                      <li>
                        <a href="product-frequently-bought-together-2.html" class="sub-nav-link"
                          >Frequently bought together 2</a
                        >
                      </li>
                      <li>
                        <a href="product-upsell-features.html" class="sub-nav-link"
                          >Product upsell features</a
                        >
                      </li>
                      <li>
                        <a href="product-pre-orders.html" class="sub-nav-link"
                          >Product pre-orders</a
                        >
                      </li>
                      <li>
                        <a href="product-notification.html" class="sub-nav-link"
                          >Back in stock notification</a
                        >
                      </li>
                      <li><a href="product-pickup.html" class="sub-nav-link">Product pickup</a></li>
                      <li>
                        <a href="product-images-grouped.html" class="sub-nav-link"
                          >Variant images grouped</a
                        >
                      </li>
                      <li>
                        <a href="product-complimentary.html" class="sub-nav-link"
                          >Complimentary products</a
                        >
                      </li>
                      <li>
                        <a href="product-quick-order-list.html" class="sub-nav-link line-clamp"
                          >Quick order list
                      ...
                      <li>
                        <a href="product-detail-buyx-gety.html" class="sub-nav-link line-clamp"
                          >Buy X Get Y
                          <div class="demo-label">
                            <span class="demo-new">New</span>
                          </div></a
          ...
          <li class="nav-mb-item">
            <a
              href="index.html#dropdown-menu-four"
              class="collapsed mb-menu-link current"
              data-bs-toggle="collapse"
              aria-expanded="true"
            ...
            <div id="dropdown-menu-four" class="collapse">
              <ul class="sub-nav-menu" id="sub-menu-navigation">
                ...
                <li>
                  <a href="payment-confirmation.html" class="sub-nav-link line-clamp"
                ...
                <li>
                  ...
                  <div id="sub-account" class="collapse">
                    <ul class="sub-nav-menu sub-menu-level-2">
                      ...
                      <li>
                        <a href="my-account-orders-details.html" class="sub-nav-link"
                          >My order details</a
                        >
                      </li>
          ...
          <li class="nav-mb-item">
            <a
              href="index.html#dropdown-menu-five"
              class="collapsed mb-menu-link current"
              data-bs-toggle="collapse"
              aria-expanded="true"
        ...
        <div class="mb-other-content">
          <div class="d-flex group-icon">
            ...
            <a href="home-search.html" class="site-nav-icon"
              ><i class="icon icon-search"></i>Search</a
            >
          </div>
          <div class="mb-notice">
    ...
    <div class="mb-canvas-content">
      <div class="mb-body">
        <ul class="nav-ul-mb" id="wrapper-menu-navigation">
          ...
          <li class="nav-mb-item">
            <a
              href="index.html#cate-menu-three"
              class="tf-category-link has-children collapsed mb-menu-link"
              data-bs-toggle="collapse"
              aria-expanded="true"
      ...
      <div class="modal-content">
        ...
        <div class="tf-login-form">
          <form class="" action="my-account.html" accept-charset="utf-8">
            ...
            <div>
              <a href="index.html#forgotPassword" data-bs-toggle="modal" class="btn-link link"
          ...
          <div class="tf-product-info-buy-button">
            <form>
              <a
                ...
                ><span>Add to cart -&nbsp;</span><span class="tf-qty-price">$18.00</span></a
              >
              ...
              <div class="w-100">
                <a href="index.html#" class="btns-full"
                  >Buy with <img src="/user/images/payments/paypal.png" alt=""
                /></a>
              ...
              <div class="tf-product-info-buy-button">
                <form class="">
                  <a
                    ...
                    class="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"
                    ><span>Add to cart -&nbsp;</span><span class="tf-qty-price">$8.00</span></a
                  >
                  <a
                    href="javascript:void(0);"
          ...
          <div class="tf-page-size-chart-content">
            ...
            <div>
              <img
                ...
                data-src="/user/images/shop/products/size_chart2.jpg"
                src="/user/images/shop/products/size_chart2.jpg"
                alt=""
              />
            </div>
          </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-top">
          <img
            class="lazyload"
            data-src="/user/images/item/banner-newleter.jpg"
            src="/user/images/item/banner-newleter.jpg"
            alt="home-01"
          />
        ...
        <div class="modal-bottom">
          ...
          <div class="text-center">
            <a
              ...
              class="tf-btn btn-line fw-6 btn-hide-popup"
              >Not interested</a
            >
          </div>
        </div>
