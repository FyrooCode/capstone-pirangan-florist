<template>
          ...
          <div class="row">
            <div class="col-xl-3 col-md-6 col-12">
              <div class="footer-col footer-col-1 footer-col-block">
                ...
                <ul class="footer-menu-list tf-collapse-content">
                  <li>
                    <a href="home-plant.html#" class="footer-menu_item">Privacy Policy</a>
                  </li>
                  <li>
                    <a href="home-plant.html#" class="footer-menu_item">Returns + Exchanges</a>
                  </li>
                  <li>
                    <a href="home-plant.html#" class="footer-menu_item">Shipping</a>
                  </li>
                  <li>
                    <a href="home-plant.html#" class="footer-menu_item">Terms &amp; Conditions</a>
                  </li>
                  <li>
                    <a href="home-plant.html#" class="footer-menu_item">FAQ’s</a>
                  </li>
                  <li>
                    <a href="home-plant.html#" class="footer-menu_item">Compare</a>
                  </li>
                  <li>
                    <a href="home-plant.html#" class="footer-menu_item">My Wishlist</a>
                  </li>
                </ul>
              </div>
            </div>
            <div class="col-xl-3 col-md-6 col-12">
              <div class="footer-col footer-col-2 footer-col-block">
                ...
                <ul class="footer-menu-list tf-collapse-content">
                  <li>
                    <a href="home-plant.html#" class="footer-menu_item">Our Story</a>
                  </li>
                  <li>
                    <a href="home-plant.html#" class="footer-menu_item">Visit Our Store</a>
                  </li>
                  <li>
                    <a href="home-plant.html#" class="footer-menu_item">Contact Us</a>
                  </li>
                  <li>
                    <a href="home-plant.html#" class="footer-menu_item">Account</a>
                  </li>
                </ul>
              </div>
            </div>
            <div class="col-xl-3 col-md-6 col-12">
              <div class="footer-col footer-col-3 footer-col-block">
                ...
                <ul class="footer-menu-list tf-collapse-content">
                  ...
                  <li>
                    <a href="home-plant.html#" class="footer-menu_item text-decoration-underline">See Our Stores</a>
                  </li>
                  <li>
                    <a href="home-plant.html#" class="footer-menu_item">(08) 8942 1299</a>
                  </li>
                  <li>
                    <a href="home-plant.html#" class="footer-menu_item">hello@domain.com</a>
                  </li>
                  <li>
                    <ul class="tf-social-icon d-flex gap-20 style-default style-white">
                      <li>
                        <a href="home-plant.html#" class="box-icon round social-facebook border-line-black"><i
                            class="icon fs-14 icon-fb"></i></a>
                      </li>
                      <li>
                        <a href="home-plant.html#" class="box-icon round social-twiter border-line-black"><i
                            class="icon fs-14 icon-Icon-x"></i></a>
                      </li>
                      <li>
                        <a href="home-plant.html#" class="box-icon round social-instagram border-line-black"><i
                            class="icon fs-14 icon-instagram"></i></a>
                      </li>
                      <li>
                        <a href="home-plant.html#" class="box-icon round social-tiktok border-line-black"><i
                            class="icon fs-14 icon-tiktok"></i></a>
                      </li>
                      <li>
                        <a href="home-plant.html#" class="box-icon round social-pinterest border-line-black"><i
                            class="icon fs-14 icon-pinterest-1"></i></a>
                      </li>
                    </ul>
                  </li>
                </ul>
              ...
              <div class="footer-newsletter footer-col-block">
                ...
                <div class="tf-collapse-content">
                  <div class="footer-menu_item">
                    Sign up to get first dibs on new arrivals, sales, exclusive content, events and
                    more!
                  </div>
                  <div class="sib-form">
                              ...
                              <div class="form__entry entry_block">
                                <div class="form__label-row">
                                  ...
                                  <div class="entry__field">
                                    <input class="input radius-60" type="text" id="EMAIL" name="EMAIL"
                                      autocomplete="off" placeholder="Enter your email...." data-required="true"
                                      required />
                                  </div>
                                </div>
          ...
          <div class="row-demo">
            <div class="demo-item">
              <a href="index.html">
                <div class="demo-image position-relative">
                  <img class="lazyload" data-src="/user/images/demo/home-01.jpg" src="/user/images/demo/home-01.jpg"
                    alt="home-01" />
            ...
            <div class="demo-item">
              <a href="home-multi-brand.html">
                <div class="demo-image position-relative">
                  <img class="lazyload" data-src="/user/images/demo/home-multi-brand.jpg"
                    src="/user/images/demo/home-multi-brand.jpg" alt="home-multi-brand" />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
            ...
            <div class="demo-item">
              <a href="home-02.html">
                <div class="demo-image position-relative">
                  <img class="lazyload" data-src="/user/images/demo/home-02.jpg" src="/user/images/demo/home-02.jpg"
                    alt="home-02" />
                  <div class="demo-label">
                    <span class="demo-hot">Hot</span>
                  </div>
            ...
            <div class="demo-item">
              <a href="home-03.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-03.jpg" src="/user/images/demo/home-03.jpg"
                    alt="home-03" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-04.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-04.jpg" src="/user/images/demo/home-04.jpg"
                    alt="home-04" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-05.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-05.jpg" src="/user/images/demo/home-05.jpg"
                    alt="home-05" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-06.html">
                <div class="demo-image position-relative">
                  <img class="lazyload" data-src="/user/images/demo/home-06.jpg" src="/user/images/demo/home-06.jpg"
                    alt="home-06" />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
                  </div>
            ...
            <div class="demo-item position-relative">
              <a href="home-personalized-pod.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-personalized-pod.jpg"
                    src="/user/images/demo/home-personalized-pod.jpg" alt="home-personalized-pod" />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
                  </div>
                </div>
            ...
            <div class="demo-item position-relative">
              <a href="home-pickleball.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-pickleball.png"
                    src="/user/images/demo/home-pickleball.png" alt="home-pickleball" />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
                  </div>
                </div>
            ...
            <div class="demo-item position-relative">
              <a href="home-ceramic.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-ceramic.png"
                    src="/user/images/demo/home-ceramic.png" alt="home-ceramic" />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
                  </div>
                </div>
            ...
            <div class="demo-item position-relative">
              <a href="home-food.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-food.png" src="/user/images/demo/home-food.png"
                    alt="home-food" />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
                  </div>
            ...
            <div class="demo-item position-relative">
              <a href="home-camp-and-hike.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-camp-and-hike.png"
                    src="/user/images/demo/home-camp-and-hike.png" alt="home-camp-and-hike" />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
                  </div>
                </div>
            ...
            <div class="demo-item">
              <a href="home-07.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-07.jpg" src="/user/images/demo/home-07.jpg"
                    alt="home-07" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-08.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-08.jpg" src="/user/images/demo/home-08.jpg"
                    alt="home-08" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-skincare.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-skincare.jpg"
                    src="/user/images/demo/home-skincare.jpg" alt="home-skincare" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-headphone.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-headphone.jpg"
                    src="/user/images/demo/home-headphone.jpg" alt="home-headphone" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-giftcard.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-giftcard.jpg"
                    src="/user/images/demo/home-giftcard.jpg" alt="home-gift-card" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-furniture.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-furniture.jpg"
                    src="/user/images/demo/home-furniture.jpg" alt="home-furniture" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-furniture-02.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-furniture2.jpg"
                    src="/user/images/demo/home-furniture2.jpg" alt="home-furniture-2" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-skateboard.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-skateboard.jpg"
                    src="/user/images/demo/home-skateboard.jpg" alt="home-skateboard" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-stroller.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-stroller.jpg"
                    src="/user/images/demo/home-stroller.jpg" alt="home-stroller" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-decor.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-decor.jpg"
                    src="/user/images/demo/home-decor.jpg" alt="home-decor" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-electronic.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-electronic.jpg"
                    src="/user/images/demo/home-electronic.jpg" alt="home-electronic" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-setup-gear.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-setup-gear.jpg"
                    src="/user/images/demo/home-setup-gear.jpg" alt="home-setup-gear" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-dog-accessories.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-dog-accessories.jpg"
                    src="/user/images/demo/home-dog-accessories.jpg" alt="home-dog-accessories" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-kitchen-wear.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-kitchen.jpg"
                    src="/user/images/demo/home-kitchen.jpg" alt="home-kitchen-wear" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-phonecase.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-phonecase.jpg"
                    src="/user/images/demo/home-phonecase.jpg" alt="home-phonecase" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-paddle-boards.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home_paddle_board.jpg"
                    src="/user/images/demo/home_paddle_board.jpg" alt="home-paddle_board" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-glasses.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-glasses.jpg"
                    src="/user/images/demo/home-glasses.jpg" alt="home-glasses" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-pod-store.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-pod-store.jpg"
                    src="/user/images/demo/home-pod-store.jpg" alt="home-pod-store" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-activewear.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-activewear.jpg"
                    src="/user/images/demo/home-activewear.jpg" alt="home-activewear" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-handbag.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-handbag.jpg"
                    src="/user/images/demo/home-handbag.jpg" alt="home-handbag" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-tee.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-tee.jpg" src="/user/images/demo/home-tee.jpg"
                    alt="home-tee" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-sock.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-socks.jpg"
                    src="/user/images/demo/home-socks.jpg" alt="home-sock" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-jewerly.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-jewelry.jpg"
                    src="/user/images/demo/home-jewelry.jpg" alt="home-jewelry" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-sneaker.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-sneaker.jpg"
                    src="/user/images/demo/home-sneaker.jpg" alt="home-sneaker" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-accessories.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-accessories.jpg"
                    src="/user/images/demo/home-accessories.jpg" alt="home-accessories" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-grocery.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-gocery.jpg"
                    src="/user/images/demo/home-gocery.jpg" alt="home-grocery" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-baby.html">
                <div class="demo-image">
                  <img class="lazyload" data-src="/user/images/demo/home-baby.jpg" src="/user/images/demo/home-baby.jpg"
                    alt="home-baby" />
                </div>
            ...
            <div class="demo-item">
              <a href="home-cosmetic.html">
                <div class="demo-image position-relative">
                  <img class="lazyload" data-src="/user/images/demo/home-cosmetic.png"
                    src="/user/images/demo/home-cosmetic.png" alt="home-cosmetic" />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
                  </div>
                </div>
            ...
            <div class="demo-item">
              <a href="home-plant.html">
                <div class="demo-image position-relative">
                  <img class="lazyload" data-src="/user/images/demo/home-plant.png"
                    src="/user/images/demo/home-plant.png" alt="home-plant" />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
                  </div>
                </div>
            ...
            <div class="demo-item">
              <a href="home-swimwear.html">
                <div class="demo-image position-relative">
                  <img class="lazyload" data-src="/user/images/demo/home-swimwear.png"
                    src="/user/images/demo/home-swimwear.png" alt="home-swimwear" />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
                  </div>
                </div>
            ...
            <div class="demo-item">
              <a href="home-electric-bike.html">
                <div class="demo-image position-relative">
                  <img class="lazyload" data-src="/user/images/demo/home-electric-bike.png"
                    src="/user/images/demo/home-electric-bike.png" alt="home-electric-bike" />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
                  </div>
                </div>
            ...
            <div class="demo-item">
              <a href="home-footwear.html">
                <div class="demo-image position-relative">
                  <img class="lazyload" data-src="/user/images/demo/home-footwear.jpg"
                    src="/user/images/demo/home-footwear.jpg" alt="home-footwear" />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
                  </div>
                </div>
            ...
            <div class="demo-item">
              <a href="home-book-store.html">
                <div class="demo-image position-relative">
                  <img class="lazyload" data-src="/user/images/demo/home-bookstore.png"
                    src="/user/images/demo/home-bookstore.png" alt="home-bookstore" />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
                  </div>
                </div>
            ...
            <div class="demo-item">
              <a href="home-gaming-accessories.html">
                <div class="demo-image position-relative">
                  <img class="lazyload" data-src="/user/images/demo/home-gaming-accessories.png"
                    src="/user/images/demo/home-gaming-accessories.png" alt="home-gaming-accessories" />
                  <div class="demo-label">
                    <span class="demo-new">New</span>
                  </div>
                </div>
      ...
      <div class="mb-body">
        <ul class="nav-ul-mb" id="wrapper-menu-navigation">
          <li class="nav-mb-item">
            <a href="index.html#dropdown-menu-one" class="collapsed mb-menu-link current" data-bs-toggle="collapse"
            ...
            <div id="dropdown-menu-one" class="collapse">
              <ul class="sub-nav-menu">
                ...
                <li>
                  <a href="home-dog-accessories.html" class="sub-nav-link">Home Dog Accessories</a>
                </li>
                ...
                <li>
                  <a href="home-paddle-boards.html" class="sub-nav-link">Home Paddle Boards</a>
                </li>
                ...
                <li>
                  <a href="home-personalized-pod.html" class="sub-nav-link">Home Personalized Pod</a>
                </li>
                ...
                <li>
                  <a href="home-camp-and-hike.html" class="sub-nav-link">Home Camp And Hike</a>
                </li>
                ...
                <li>
                  <a href="home-electric-bike.html" class="sub-nav-link">Home Electric Bike</a>
                </li>
                ...
                <li>
                  <a href="home-gaming-accessories.html" class="sub-nav-link">Home Gaming Accessories</a>
                </li>
          ...
          <li class="nav-mb-item">
            <a href="index.html#dropdown-menu-two" class="collapsed mb-menu-link current" data-bs-toggle="collapse"
            ...
            <div id="dropdown-menu-two" class="collapse">
              <ul class="sub-nav-menu" id="sub-menu-navigation">
                <li>
                  <a href="index.html#sub-shop-one" class="sub-nav-link collapsed" data-bs-toggle="collapse"
                  ...
                  <div id="sub-shop-one" class="collapse">
                    <ul class="sub-nav-menu sub-menu-level-2">
                      ...
                      <li>
                        <a href="shop-collection-sub.html" class="sub-nav-link">Sub collection</a>
                      </li>
                      <li>
                        <a href="shop-collection-list.html" class="sub-nav-link">Collections list</a>
                      </li>
                    </ul>
                  </div>
                </li>
                <li>
                  <a href="index.html#sub-shop-two" class="sub-nav-link collapsed" data-bs-toggle="collapse"
                  ...
                  <div id="sub-shop-two" class="collapse">
                    <ul class="sub-nav-menu sub-menu-level-2">
                      ...
                      <li>
                        <a href="shop-loadmore.html" class="sub-nav-link">Pagination loadmore</a>
                      </li>
                      <li>
                        <a href="shop-infinite-scrolling.html" class="sub-nav-link">Pagination infinite scrolling</a>
                      </li>
                      <li>
                        <a href="shop-filter-sidebar.html" class="sub-nav-link">Filter sidebar</a>
                      </li>
                      <li>
                        <a href="shop-filter-hidden.html" class="sub-nav-link">Filter hidden</a>
                      </li>
                    </ul>
                  </div>
                </li>
                <li>
                  <a href="index.html#sub-shop-three" class="sub-nav-link collapsed" data-bs-toggle="collapse"
                  ...
                  <div id="sub-shop-three" class="collapse">
                    <ul class="sub-nav-menu sub-menu-level-2">
                      <li>
                        <a href="product-style-01.html" class="sub-nav-link">Product style 01</a>
                      </li>
                      <li>
                        <a href="product-style-02.html" class="sub-nav-link">Product style 02</a>
                      </li>
                      <li>
                        <a href="product-style-03.html" class="sub-nav-link">Product style 03</a>
                      </li>
                      <li>
                        <a href="product-style-04.html" class="sub-nav-link">Product style 04</a>
                      </li>
                      <li>
                        <a href="product-style-05.html" class="sub-nav-link">Product style 05</a>
                      </li>
                      <li>
                        <a href="product-style-06.html" class="sub-nav-link">Product style 06</a>
                      </li>
                      <li>
                        <a href="product-style-07.html" class="sub-nav-link">Product style 07</a>
                      </li>
                    </ul>
                  </div>
                </li>
          ...
          <li class="nav-mb-item">
            <a href="index.html#dropdown-menu-three" class="collapsed mb-menu-link current" data-bs-toggle="collapse"
            ...
            <div id="dropdown-menu-three" class="collapse">
              <ul class="sub-nav-menu" id="sub-menu-navigation">
                <li>
                  <a href="index.html#sub-product-one" class="sub-nav-link collapsed" data-bs-toggle="collapse"
                  ...
                  <div id="sub-product-one" class="collapse">
                    <ul class="sub-nav-menu sub-menu-level-2">
                      ...
                      <li>
                        <a href="product-right-thumbnails.html" class="sub-nav-link">Product right thumbnails</a>
                      </li>
                      <li>
                        <a href="product-bottom-thumbnails.html" class="sub-nav-link">Product bottom thumbnails</a>
                      </li>
                      <li>
                        <a href="product-drawer-sidebar.html" class="sub-nav-link">Product drawer sidebar</a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="product-description-list.html" class="sub-nav-link">Product description list</a>
                      </li>
                      <li>
                ...
                <li>
                  <a href="index.html#sub-product-two" class="sub-nav-link collapsed" data-bs-toggle="collapse"
                  ...
                  <div id="sub-product-two" class="collapse">
                    <ul class="sub-nav-menu sub-menu-level-2">
                      <li>
                        <a href="product-inner-zoom.html" class="sub-nav-link">Product inner zoom</a>
                      </li>
                      <li>
                        <a href="product-zoom-magnifier.html" class="sub-nav-link">Product zoom magnifier</a>
                      </li>
                      <li>
                        <a href="product-no-zoom.html" class="sub-nav-link">Product no zoom</a>
                      </li>
                      <li>
                        <a href="product-photoswipe-popup.html" class="sub-nav-link">Product photoswipe popup</a>
                      </li>
                      <li>
                        <a href="product-zoom-popup.html" class="sub-nav-link">Product external zoom and photoswipe
                          popup</a>
                      </li>
                      <li><a href="product-video.html" class="sub-nav-link">Product video</a></li>
                      <li>
                        <a href="product-3d.html" class="sub-nav-link">Product 3D, AR models</a>
                      </li>
                      <li>
                        <a href="product-options-customizer.html" class="sub-nav-link">Product options & customizer</a>
                      </li>
                      <li>
                        <a href="product-advanced-types.html" class="sub-nav-link">Advanced product types</a>
                      </li>
                      <li>
                        <a href="product-giftcard.html" class="sub-nav-link">Recipient information form for gift card
                          products</a>
                      </li>
                    </ul>
                  </div>
                ...
                <li>
                  <a href="index.html#sub-product-three" class="sub-nav-link collapsed" data-bs-toggle="collapse"
                  ...
                  <div id="sub-product-three" class="collapse">
                    <ul class="sub-nav-menu sub-menu-level-2">
                      <li>
                        <a href="product-color-swatch.html" class="sub-nav-link">Product color swatch</a>
                      </li>
                      <li>
                        <a href="product-rectangle.html" class="sub-nav-link">Product rectangle</a>
                      </li>
                      <li>
                        <a href="product-rectangle-color.html" class="sub-nav-link">Product rectangle color</a>
                      </li>
                      <li>
                        <a href="product-swatch-image.html" class="sub-nav-link">Product swatch image</a>
                      </li>
                      <li>
                        <a href="product-swatch-image-rounded.html" class="sub-nav-link">Product swatch image
                          rounded</a>
                      </li>
                      <li>
                        <a href="product-swatch-dropdown.html" class="sub-nav-link">Product swatch dropdown</a>
                      </li>
                      <li>
                        <a href="product-swatch-dropdown-color.html" class="sub-nav-link">Product swatch dropdown
                          color</a>
                      </li>
                    </ul>
                  </div>
                ...
                <li>
                  <a href="index.html#sub-product-four" class="sub-nav-link collapsed" data-bs-toggle="collapse"
                  ...
                  <div id="sub-product-four" class="collapse">
                    <ul class="sub-nav-menu sub-menu-level-2">
                      <li>
                        <a href="product-frequently-bought-together.html" class="sub-nav-link">Frequently bought
                          together</a>
                      </li>
                      <li>
                        <a href="product-frequently-bought-together-2.html" class="sub-nav-link">Frequently bought
                          together 2</a>
                      </li>
                      <li>
                        <a href="product-upsell-features.html" class="sub-nav-link">Product upsell features</a>
                      </li>
                      <li>
                        <a href="product-pre-orders.html" class="sub-nav-link">Product pre-orders</a>
                      </li>
                      <li>
                        <a href="product-notification.html" class="sub-nav-link">Back in stock notification</a>
                      </li>
                      <li><a href="product-pickup.html" class="sub-nav-link">Product pickup</a></li>
                      <li>
                        <a href="product-images-grouped.html" class="sub-nav-link">Variant images grouped</a>
                      </li>
                      <li>
                        <a href="product-complimentary.html" class="sub-nav-link">Complimentary products</a>
                      </li>
                      <li>
                        <a href="product-quick-order-list.html" class="sub-nav-link line-clamp">Quick order list
                          <div class="demo-label"><span class="demo-new">New</span></div>
                        </a>
                      </li>
                      <li>
                        <a href="product-detail-volume-discount.html" class="sub-nav-link line-clamp">Volume Discount
                          <div class="demo-label"><span class="demo-new">New</span></div>
                        </a>
                      </li>
                      <li>
                        <a href="product-detail-volume-discount-grid.html" class="sub-nav-link line-clamp">Volume
                          Discount Grid
                          <div class="demo-label"><span class="demo-new">New</span></div>
                        </a>
                      </li>
                      <li>
                        <a href="product-detail-buyx-gety.html" class="sub-nav-link line-clamp">Buy X Get Y
                          <div class="demo-label">
                            <span class="demo-new">New</span>
                          </div>
                        </a>
          ...
          <li class="nav-mb-item">
            <a href="index.html#dropdown-menu-four" class="collapsed mb-menu-link current" data-bs-toggle="collapse"
            ...
            <div id="dropdown-menu-four" class="collapse">
              <ul class="sub-nav-menu" id="sub-menu-navigation">
                ...
                <li>
                  <a href="brands.html" class="sub-nav-link line-clamp">Brands
                    <div class="demo-label">
                      <span class="demo-new">New</span>
                    </div>
                  </a>
                ...
                <li>
                  <a href="timeline.html" class="sub-nav-link line-clamp">Timeline
                    <div class="demo-label"><span class="demo-new">New</span></div>
                  </a>
                </li>
                ...
                <li>
                  <a href="payment-confirmation.html" class="sub-nav-link line-clamp">Payment Confirmation</a>
                </li>
                <li>
                  <a href="payment-failure.html" class="sub-nav-link line-clamp">Payment Failure</a>
                </li>
                <li>
                  <a href="index.html#sub-account" class="sub-nav-link collapsed" data-bs-toggle="collapse"
                  ...
                  <div id="sub-account" class="collapse">
                    <ul class="sub-nav-menu sub-menu-level-2">
                      ...
                      <li>
                        <a href="my-account-orders-details.html" class="sub-nav-link">My order details</a>
                      </li>
                      <li><a href="my-account-address.html" class="sub-nav-link">My address</a></li>
                      <li>
                        <a href="my-account-edit.html" class="sub-nav-link">My account details</a>
                      </li>
                      <li>
                        <a href="my-account-wishlist.html" class="sub-nav-link">My wishlist</a>
                      </li>
                    </ul>
                  </div>
                </li>
          ...
          <li class="nav-mb-item">
            <a href="index.html#dropdown-menu-five" class="collapsed mb-menu-link current" data-bs-toggle="collapse"
      ...
      <header class="tf-search-head">
        ...
        <div class="tf-search-sticky">
          <form class="tf-mini-search-frm">
            <fieldset class="text">
              <input type="text" placeholder="Search" class="" name="text" tabindex="0" value="" aria-required="true"
                required="" />
            </fieldset>
            ...
            <div class="tf-col-content">
              ...
              <div class="tf-search-hidden-inner">
                <div class="tf-loop-item">
                  <div class="image">
                    <a href="product-detail.html">
                      <img src="/user/images/products/white-3.jpg" alt="" />
                    </a>
                  </div>
                  <div class="content">
                ...
                <div class="tf-loop-item">
                  <div class="image">
                    <a href="product-detail.html">
                      <img src="/user/images/products/white-2.jpg" alt="" />
                    </a>
                  </div>
                  <div class="content">
                ...
                <div class="tf-loop-item">
                  <div class="image">
                    <a href="product-detail.html">
                      <img src="/user/images/products/white-1.jpg" alt="" />
                    </a>
                  </div>
                  <div class="content">
        ...
        <ul class="nav-ul-mb" id="wrapper-menu-navigation">
          <li class="nav-mb-item">
            <a href="shop-default.html" class="tf-category-link mb-menu-link">
              <div class="image">
                <img src="/user/images/shop/cate/cate1.jpg" alt="" />
              </div>
          ...
          <li class="nav-mb-item">
            <a href="shop-default.html" class="tf-category-link mb-menu-link">
              <div class="image">
                <img src="/user/images/shop/cate/cate2.jpg" alt="" />
              </div>
              <span>Dog</span>
            </a>
          </li>
          <li class="nav-mb-item">
            <a href="shop-default.html" class="tf-category-link mb-menu-link">
              <div class="image">
                <img src="/user/images/shop/cate/cate3.jpg" alt="" />
              </div>
              <span>Grocery</span>
            </a>
          </li>
          <li class="nav-mb-item">
            <a href="shop-default.html" class="tf-category-link mb-menu-link">
              <div class="image">
                <img src="/user/images/shop/cate/cate4.png" alt="" />
              </div>
              <span>Handbag</span>
            </a>
          </li>
          <li class="nav-mb-item">
            <a href="index.html#cate-menu-one" class="tf-category-link has-children collapsed mb-menu-link"
              data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-menu-one">
              <div class="image">
                <img src="/user/images/shop/cate/cate5.jpg" alt="" />
              </div>
              <span>Fashion</span>
              <span class="btn-open-sub"></span>
            </a>
            <div id="cate-menu-one" class="collapse list-cate">
              <ul class="sub-nav-menu" id="cate-menu-navigation">
                <li>
                  <a href="index.html#cate-shop-one" class="tf-category-link has-children sub-nav-link collapsed"
                    data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-shop-one">
                    <div class="image">
                      <img src="/user/images/shop/cate/cate6.jpg" alt="" />
                    </div>
                    <span>Mens</span>
                    <span class="btn-open-sub"></span>
                  </a>
                  <div id="cate-shop-one" class="collapse">
                    <ul class="sub-nav-menu sub-menu-level-2">
                      ...
                      <li>
                        <a href="shop-default.html" class="tf-category-link sub-nav-link">
                          <div class="image">
                            <img src="/user/images/shop/cate/cate8.jpg" alt="" />
                          </div>
                          <span>Shoes</span>
                        </a>
                      </li>
                ...
                <li>
                  <a href="index.html#cate-shop-two" class="tf-category-link has-children sub-nav-link collapsed"
                    data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-shop-two">
                    <div class="image">
                      <img src="/user/images/shop/cate/cate9.jpg" alt="" />
                    </div>
                    <span>Womens</span>
                    <span class="btn-open-sub"></span>
                  </a>
                  <div id="cate-shop-two" class="collapse">
                    <ul class="sub-nav-menu sub-menu-level-2">
                      ...
                      <li>
                        <a href="shop-default.html" class="tf-category-link sub-nav-link">
                          <div class="image">
                            <img src="/user/images/shop/cate/cate7.jpg" alt="" />
                          </div>
                          <span>Tee</span>
                        </a>
                      </li>
          ...
          <li class="nav-mb-item">
            <a href="index.html#cate-menu-two" class="tf-category-link has-children collapsed mb-menu-link"
          ...
          <li class="nav-mb-item">
            <a href="index.html#cate-menu-three" class="tf-category-link has-children collapsed mb-menu-link"
            ...
            <div class="tf-mini-cart-bottom">
              <div class="tf-mini-cart-tool">
                ...
                <div class="tf-mini-cart-tool-btn btn-add-gift">
                  <svg xmlns="http://www.w3.org/2000/svg" width="17" height="18" viewBox="0 0 17 18"
                    fill="currentColor">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                      d="M2.99566 2.73409C2.99566 0.55401 5.42538 -0.746668 7.23916 0.463462L8.50073 1.30516L9.7623 0.463462C11.5761 -0.746668 14.0058 0.55401 14.0058 2.73409V3.24744H14.8225C15.9633 3.24744 16.8881 4.17233 16.8881 5.31312V6.82566C16.8881 7.21396 16.5734 7.52873 16.1851 7.52873H15.8905V15.1877C15.8905 15.1905 15.8905 15.1933 15.8905 15.196C15.886 16.7454 14.6286 18 13.0782 18H3.92323C2.37003 18 1.11091 16.7409 1.11091 15.1877V7.52877H0.81636C0.42806 7.52877 0.113281 7.21399 0.113281 6.82569V5.31316C0.113281 4.17228 1.03812 3.24744 2.179 3.24744H2.99566V2.73409ZM4.40181 3.24744H7.79765V2.52647L6.45874 1.63317C5.57987 1.0468 4.40181 1.67677 4.40181 2.73409V3.24744ZM9.20381 2.52647V3.24744H12.5996V2.73409C12.5996 1.67677 11.4216 1.0468 10.5427 1.63317L9.20381 2.52647ZM2.179 4.6536C1.81472 4.6536 1.51944 4.94888 1.51944 5.31316V6.12261H5.73398L5.734 4.6536H2.179ZM5.73401 7.52877V13.9306C5.73401 14.1806 5.86682 14.4119 6.08281 14.5379C6.29879 14.6639 6.56545 14.6657 6.78312 14.5426L8.50073 13.5715L10.2183 14.5426C10.436 14.6657 10.7027 14.6639 10.9187 14.5379C11.1346 14.4119 11.2674 14.1806 11.2674 13.9306V7.52873H14.4844V15.1603C14.4843 15.1627 14.4843 15.1651 14.4843 15.1675V15.1877C14.4843 15.9643 13.8548 16.5938 13.0782 16.5938H3.92323C3.14663 16.5938 2.51707 15.9643 2.51707 15.1877V7.52877H5.73401ZM15.482 6.12258V5.31312C15.482 4.94891 15.1867 4.6536 14.8225 4.6536H11.2674V6.12258H15.482ZM9.86129 4.6536H7.14017V12.7254L8.15469 12.1518C8.36941 12.0304 8.63204 12.0304 8.84676 12.1518L9.86129 12.7254V4.6536Z">
                    </path>
                  </svg>
                </div>
                <div class="tf-mini-cart-tool-btn btn-estimate-shipping">
                  <svg xmlns="http://www.w3.org/2000/svg" width="26" height="18" viewBox="0 0 26 18"
                    fill="currentColor">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                      d="M0 0.811989C0 0.36354 0.36354 0 0.811989 0H15.4278C15.8763 0 16.2398 0.36354 16.2398 0.811989V3.10596H21.0144C23.6241 3.10596 25.8643 5.05894 25.8643 7.61523V14.6414C25.8643 15.0899 25.5007 15.4534 25.0523 15.4534H23.545C23.2139 16.9115 21.9098 18 20.3514 18C18.7931 18 17.4889 16.9115 17.1578 15.4534H8.69534C8.36423 16.9115 7.0601 18 5.50175 18C3.9434 18 2.63927 16.9115 2.30815 15.4534H0.811989C0.36354 15.4534 0 15.0899 0 14.6414V0.811989ZM2.35089 13.8294C2.74052 12.4562 4.00366 11.4503 5.50175 11.4503C6.99983 11.4503 8.26298 12.4562 8.6526 13.8294H14.6158V1.62398H1.62398V13.8294H2.35089ZM16.2398 4.72994V7.95749H24.2403V7.61523C24.2403 6.08759 22.8649 4.72994 21.0144 4.72994H16.2398ZM24.2403 9.58147H16.2398V13.8294H17.2006C17.5902 12.4562 18.8533 11.4503 20.3514 11.4503C21.8495 11.4503 23.1126 12.4562 23.5023 13.8294H24.2403V9.58147ZM5.50175 13.0743C4.58999 13.0743 3.43652 13.8134 3.43652 14.7251C3.43652 15.6369 4.58999 16.376 5.50175 16.376C6.41351 16.376 7.15263 15.6369 7.15263 14.7251C7.15263 13.8134 6.41351 13.0743 5.50175 13.0743ZM16.2703 13.0743C15.5611 13.0743 14.9863 13.8134 14.9863 14.7251C14.9863 15.6369 15.5611 16.376 16.2703 16.376C16.9794 16.376 17.5543 15.6369 17.5543 14.7251C17.5543 13.8134 16.9794 13.0743 16.2703 13.0743Z">
                    </path>
                  </svg>
                </div>
              </div>
              <div class="tf-mini-cart-bottom-wrap">
                ...
                <div class="tf-cart-tax">
                  Taxes and <a href="index.html#">shipping</a> calculated at checkout
                </div>
                ...
                <div class="tf-mini-cart-view-checkout">
                  <a href="view-cart.html" class="tf-btn btn-outline radius-3 link w-100 justify-content-center">View
                    cart</a>
                ...
                <div class="tf-compare-offcanvas">
                  <div class="tf-compare-item">
                    <div class="position-relative">
                      ...
                      <a href="product-detail.html">
                        <img class="radius-3" src="/user/images/products/orange-1.jpg" alt="" />
                      </a>
                    </div>
                  </div>
                  <div class="tf-compare-item">
                    <div class="position-relative">
                      ...
                      <a href="product-detail.html">
                        <img class="radius-3" src="/user/images/products/pink-1.jpg" alt="" />
                      </a>
                    </div>
                  </div>
                </div>
      ...
      <div class="modal-content">
        ...
        <div class="wrap">
          <div class="tf-product-info-item">
            <div class="image">
              <img src="/user/images/products/orange-1.jpg" alt="" />
            </div>
            <div class="content">
          ...
          <div class="tf-product-info-buy-button">
            <form>
              ...
              <a href="index.html#compare" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft"
          ...
          <div class="tf-product-media-wrap">
            <div dir="ltr" class="swiper tf-single-slide">
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="item">
                    <img src="/user/images/products/pink-1.jpg" alt="" />
                  </div>
                </div>
              </div>
          ...
          <div class="tf-product-info-wrap position-relative">
            <div class="tf-product-info-list">
              ...
              <div class="tf-product-description">
                <p>
                  Nunc arcu faucibus a et lorem eu a mauris adipiscing conubia ac aptent ligula
                  facilisis a auctor habitant parturient a a.Interdum fermentum.
                </p>
              </div>
      ...
      <div class="modal-content">
        ...
        <div class="tf-rte">
          ...
          <div class="tf-page-size-chart-content">
            ...
            <div>
              <img class="sizechart lazyload" data-src="/user/images/shop/products/size_chart2.jpg"
                src="/user/images/shop/products/size_chart2.jpg" alt="" />
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="modal modalCentered fade auto-popup modal-newleter">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-top">
          <img class="lazyload" data-src="/user/images/item/banner-newleter.jpg"
            src="/user/images/item/banner-newleter.jpg" alt="home-01" />
