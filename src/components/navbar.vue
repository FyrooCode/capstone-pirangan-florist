    ...
    <div class="container-full px_15 lg-px_40">
      <div class="row wrapper-header align-items-center">
        <div class="col-md-4 col-3 tf-lg-hidden">
          <a href="home-plant.html#mobileMenu" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft">
        ...
        <div class="col-xl-9 col-md-4 col-6">
          <div class="wrap-header-left">
            <router-link to="/" class="logo-header">
              <img src="/user/images/logo/priangan-florist.png" alt="" />
            </router-link>
            <nav class="box-navigation text-center">
              <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                ...
                <li class="menu-item">
                  <router-link to="/lokasi-outlet" class="item-link text_green-1">Lokasi Outlet</router-link>
                </li>
                <li class="menu-item">
                  <a href="home-plant.html#" class="item-link text_green-1">Testimonial</a>
                </li>
              </ul>
            </nav>
          </div>
