            ...
            <div class="container">
                <div class="tf-shop-control grid-3 align-items-center">
                    <div class="tf-control-filter">
                        <a href="shop-right-sidebar.html#filterShop" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft" class="tf-btn-filter"><span class="icon icon-filter"></span><span class="text">Filter</span></a>
                    </div>
                        ...
                        <div class="tf-list-layout wrapper-shop" id="listLayout">
                            ...
                            <div class="card-product list-layout" data-availability="In stock" data-brand="Ecomus">
                                <div class="card-product-wrapper">
                                    <a href="shop-right-sidebar.html#" class="product-img">
                                ...
                                <div class="card-product-info">
                                    <a href="shop-right-sidebar.html#" class="title link">Ribbed Tank Top</a>
                                    ...
                                    <div class="list-product-btn">
                                        <a href="shop-right-sidebar.html#quick_add" data-bs-toggle="modal" class="box-icon quick-add style-3 hover-tooltip"><span class="icon icon-bag"></span><span class="tooltip">Quick add</span></a>
                                        <a href="shop-right-sidebar.html#" class="box-icon wishlist style-3 hover-tooltip"><span class="icon icon-heart"></span> <span class="tooltip">Add to Wishlist</span></a>
                                        <a href="shop-right-sidebar.html#compare" data-bs-toggle="offcanvas" class="box-icon compare style-3 hover-tooltip"><span class="icon icon-compare"></span> <span class="tooltip">Add to Compare</span></a>
                                        <a href="shop-right-sidebar.html#quick_view" data-bs-toggle="modal" class="box-icon quickview style-3 hover-tooltip"><span class="icon icon-view"></span><span class="tooltip">Quick view</span></a>
                                    </div>
                                </div>
                            </div>
                            <!-- card product 2 -->
                            <div class="card-product list-layout" data-availability="In stock" data-brand="Ecomus">
                                ...
                                <div class="card-product-info">
                                    <a href="shop-right-sidebar.html#" class="title link">Ribbed modal T-shirt</a>
                                    ...
                                    <div class="list-product-btn">
                                        <a href="shop-right-sidebar.html#quick_add" data-bs-toggle="modal" class="box-icon quick-add style-3"><span class="icon icon-bag"></span><span class="tooltip">Quick add</span></a>
                                        <a href="shop-right-sidebar.html#" class="box-icon wishlist style-3"><span class="icon icon-heart"></span> <span class="tooltip">Add to Wishlist</span></a>
                                        <a href="shop-right-sidebar.html#compare" data-bs-toggle="offcanvas" class="box-icon compare style-3"><span class="icon icon-compare"></span> <span class="tooltip">Add to Compare</span></a>
                                        <a href="shop-right-sidebar.html#quick_view" data-bs-toggle="modal" class="box-icon quickview style-3"><span class="icon icon-view"></span><span class="tooltip">Quick view</span></a>
                                    </div>
                                </div>
                            </div>
                            <!-- card product 3 -->
                            <div class="card-product list-layout" data-availability="In stock" data-brand="Ecomus">
                                ...
                                <div class="card-product-info">
                                    <a href="shop-right-sidebar.html#" class="title link">Oversized Printed T-shirt</a>
                            ...
                            <div class="card-product list-layout" data-availability="In stock" data-brand="Ecomus">
                                ...
                                <div class="card-product-info">
                                    <a href="shop-right-sidebar.html#" class="title link">V-neck linen T-shirt</a>
                            ...
                            <div class="card-product list-layout" data-availability="In stock" data-brand="M&H">
                                ...
                                <div class="card-product-info">
                                    <a href="shop-right-sidebar.html#" class="title link">Loose Fit Sweatshirt</a>
                                    <span class="price current-price">$10.00</span>
                                    <p class="description">Button-up shirt sleeves and a relaxed silhouette. It’s tailored with drapey, crinkle-texture fabric that’s made from LENZING™ ECOVERO™ Viscose — responsibly sourced wood-based fibres produced through a process that reduces...</p>
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch active">
                            ...
                            <div class="card-product list-layout" data-availability="Out of stock" data-brand="M&H">
                                <div class="card-product-wrapper">
                                    <div class="product-img">
                                        <img class="lazyload img-product" data-src="/user/images/products/black-4.jpg" src="/user/images/products/black-4.jpg" alt="image-product">
                                        <img class="lazyload img-hover" data-src="/user/images/products/black-5.jpg" src="/user/images/products/black-5.jpg" alt="image-product">
                                    </div>
                                </div>
                                <div class="card-product-info">
                                    <a href="shop-right-sidebar.html#" class="title link">Regular Fit Oxford Shirt</a>
                                    <span class="price current-price">$10.00</span>
                                    <p class="description">Button-up shirt sleeves and a relaxed silhouette. It’s tailored with drapey, crinkle-texture fabric that’s made from LENZING™ ECOVERO™ Viscose — responsibly sourced wood-based fibres produced through a process that reduces...</p>
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch active">
                                            <span class="tooltip">Black</span>
                                            <span class="swatch-value bg_dark"></span>
                                            <img class="lazyload" data-src="/user/images/products/black-4.jpg" src="/user/images/products/black-4.jpg" alt="image-product">
                                        </li>
                                        <li class="list-color-item color-swatch">
                                            <span class="tooltip">Dark Blue</span>
                                            <span class="swatch-value bg_dark-blue"></span>
                                            <img class="lazyload" data-src="/user/images/products/dark-blue-2.jpg" src="/user/images/products/dark-blue-2.jpg" alt="image-product">
                                        </li>
                                        <li class="list-color-item color-swatch">
                                            <span class="tooltip">Beige</span>
                                            <span class="swatch-value bg_beige"></span>
                                            <img class="lazyload" data-src="/user/images/products/beige.jpg" src="/user/images/products/beige.jpg" alt="image-product">
                                        </li>
                                        <li class="list-color-item color-swatch">
                                            <span class="tooltip">Light Blue</span>
                                            <span class="swatch-value bg_light-blue"></span>
                                            <img class="lazyload" data-src="/user/images/products/light-blue.jpg" src="/user/images/products/light-blue.jpg" alt="image-product">
                                        </li>
                                        <li class="list-color-item color-swatch">
                                            <span class="tooltip">White</span>
                                            <span class="swatch-value bg_white"></span>
                                            <img class="lazyload" data-src="/user/images/products/white-7.jpg" src="/user/images/products/white-7.jpg" alt="image-product">
                                        </li>
                                    </ul>
                                    <div class="size-list">
                                        <span class="size-item">S</span>
                            ...
                            <div class="card-product list-layout" data-availability="Out of stock" data-brand="M&H">
                                <div class="card-product-wrapper">
                                    <div class="product-img">
                                        <img class="lazyload img-product" data-src="/user/images/products/white-8.jpg" src="/user/images/products/white-8.jpg" alt="image-product">
                                        <img class="lazyload img-hover" data-src="/user/images/products/black-6.jpg" src="/user/images/products/black-6.jpg" alt="image-product">
                                    </div>
                                </div>
                                <div class="card-product-info">
                                    <a href="shop-right-sidebar.html#" class="title link">Loose Fit Hoodie</a>
                                    ...
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch active">
                                            <span class="tooltip">White</span>
                                            <span class="swatch-value bg_white"></span>
                                            <img class="lazyload" data-src="/user/images/products/white-8.jpg" src="/user/images/products/white-8.jpg" alt="image-product">
                                        </li>
                                        <li class="list-color-item color-swatch">
                                            <span class="tooltip">Black</span>
                                            <span class="swatch-value bg_dark"></span>
                                            <img class="lazyload" data-src="/user/images/products/black-7.jpg" src="/user/images/products/black-7.jpg" alt="image-product">
                                        </li>
                                        <li class="list-color-item color-swatch">
                                            <span class="tooltip">Blue</span>
                                            <span class="swatch-value bg_blue-2"></span>
                                            <img class="lazyload" data-src="/user/images/products/blue-2.jpg" src="/user/images/products/blue-2.jpg" alt="image-product">
                                        </li>
                                    </ul>
                                    <div class="size-list">
                                        <span class="size-item">S</span>
                            ...
                            <ul class="wg-pagination tf-pagination-list justify-content-start">
                                <li class="active">
                                    <a href="shop-right-sidebar.html#" class="pagination-link">1</a>
                                </li>
                                <li>
                                    <a href="shop-right-sidebar.html#" class="pagination-link animate-hover-btn">2</a>
                                </li>
                                <li>
                                    <a href="shop-right-sidebar.html#" class="pagination-link animate-hover-btn">3</a>
                                </li>
                                <li>
                                    <a href="shop-right-sidebar.html#" class="pagination-link animate-hover-btn">
                        ...
                        <div class="tf-grid-layout wrapper-shop tf-col-3" id="gridLayout">
                            ...
                            <div class="card-product grid" data-availability="In stock" data-brand="Ecomus">
                                <div class="card-product-wrapper">
                                    ...
                                    <div class="list-product-btn absolute-2">
                                        <a href="shop-right-sidebar.html#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                        ...
                                        <a href="shop-right-sidebar.html#compare" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft" class="box-icon bg_white compare btn-icon-action">
                                            <span class="icon icon-compare"></span>
                                            <span class="tooltip">Add to Compare</span>
                                            <span class="icon icon-check"></span>
                                        </a>
                                        <a href="shop-right-sidebar.html#quick_view" data-bs-toggle="modal" class="box-icon bg_white quickview tf-btn-loading">
                            ...
                            <div class="card-product grid" data-availability="In stock" data-brand="Ecomus">
                                <div class="card-product-wrapper">
                                    ...
                                    <div class="list-product-btn absolute-2">
                                        <a href="shop-right-sidebar.html#shoppingCart" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                            <span class="icon icon-bag"></span>
                            ...
                            <div class="card-product grid" data-availability="In stock" data-brand="M&H">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" data-src="/user/images/products/brown-4.jpg" src="/user/images/products/brown-4.jpg" alt="image-product">
                                        <img class="lazyload img-hover" data-src="/user/images/products/black-8.jpg" src="/user/images/products/black-8.jpg" alt="image-product">
                                    </a>
                                    <div class="size-list">
                                        <span class="size-item">M</span>
                                        <span class="size-item">L</span>
                                ...
                                <div class="card-product-info">
                                    ...
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch active">
                                            <span class="tooltip">Brown</span>
                                            <span class="swatch-value bg_brown"></span>
                                            <img class="lazyload" data-src="/user/images/products/brown-4.jpg" src="/user/images/products/brown-4.jpg" alt="image-product">
                                        </li>
                                        <li class="list-color-item color-swatch">
                                            <span class="tooltip">Black</span>
                                            <span class="swatch-value bg_dark"></span>
                                            <img class="lazyload" data-src="/user/images/products/black-8.jpg" src="/user/images/products/black-8.jpg" alt="image-product">
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="card-product grid" data-availability="In stock" data-brand="M&H">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" data-src="/user/images/products/black-9.jpg" src="/user/images/products/black-9.jpg" alt="image-product">
                                        <img class="lazyload img-hover" data-src="/user/images/products/black-10.jpg" src="/user/images/products/black-10.jpg" alt="image-product">
                                    </a>
                                    <div class="size-list">
                                        <span class="size-item">S</span>
                                        <span class="size-item">M</span>
                                ...
                                <div class="card-product-info">
                                    ...
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch active">
                                            <span class="tooltip">Black</span>
                                            <span class="swatch-value bg_dark"></span>
                                            <img class="lazyload" data-src="/user/images/products/black-9.jpg" src="/user/images/products/black-9.jpg" alt="image-product">
                                        </li>
                                        <li class="list-color-item color-swatch">
                                            <span class="tooltip">White</span>
                                            <span class="swatch-value bg_white"></span>
                                            <img class="lazyload" data-src="/user/images/products/white-9.jpg" src="/user/images/products/white-9.jpg" alt="image-product">
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="card-product grid" data-availability="Out of stock" data-brand="M&H">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" data-src="/user/images/products/grey-2.jpg" src="/user/images/products/grey-2.jpg" alt="image-product">
                                        <img class="lazyload img-hover" data-src="/user/images/products/grey.jpg" src="/user/images/products/grey.jpg" alt="image-product">
                                    </a>
                                    <div class="size-list">
                                        <span class="size-item">S</span>
                                        <span class="size-item">M</span>
                                ...
                                <div class="card-product-info">
                                    ...
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch active">
                                            ...
                                            <img class="lazyload" data-src="/user/images/products/grey-2.jpg" src="/user/images/products/grey-2.jpg" alt="image-product">
                                        </li>
                                        <li class="list-color-item color-swatch">
                                            <span class="tooltip">Pink</span>
                                            <span class="swatch-value bg_pink"></span>
                                            <img class="lazyload" data-src="/user/images/products/pink-2.jpg" src="/user/images/products/pink-2.jpg" alt="image-product">
                                        </li>
                                        <li class="list-color-item color-swatch">
                                            <span class="tooltip">Light Pink</span>
                                            <span class="swatch-value bg_light-pink"></span>
                                            <img class="lazyload" data-src="/user/images/products/light-pink.jpg" src="/user/images/products/light-pink.jpg" alt="image-product">
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="card-product grid" data-availability="Out of stock" data-brand="M&H">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" data-src="/user/images/products/black-11.jpg" src="/user/images/products/black-11.jpg" alt="image-product">
                                        <img class="lazyload img-hover" data-src="/user/images/products/black-12.jpg" src="/user/images/products/black-12.jpg" alt="image-product">
                                    </a>
                                    <div class="size-list">
                                        <span class="size-item">S</span>
                                        <span class="size-item">M</span>
                            ...
                            <ul class="wg-pagination tf-pagination-list">
                                ...
                                <li>
                                    <a href="shop-right-sidebar.html#" class="pagination-link animate-hover-btn">4</a>
                                </li>
                                <li>
                                    <a href="shop-right-sidebar.html#" class="pagination-link animate-hover-btn">
                                        <span class="icon icon-arrow-right"></span>
                        ...
                        <div class="widget-facet wd-categories">
                            ...
                            <div id="categories" class="collapse show">
                                <ul class="list-categoris current-scrollbar mb_36">
                                    <li class="cate-item current"><a href="shop-right-sidebar.html#"><span>Fashion</span>&nbsp;<span>(31)</span></a></li>
                                    <li class="cate-item"><a href="shop-right-sidebar.html#"><span>Men</span>&nbsp;<span>(9)</span></a></li>
                                    <li class="cate-item"><a href="shop-right-sidebar.html#"><span>Women</span>&nbsp;<span>(23)</span></a></li>
                                    <li class="cate-item"><a href="shop-right-sidebar.html#"><span>Denim</span>&nbsp;<span>(20)</span></a></li>
                                    <li class="cate-item"><a href="shop-right-sidebar.html#"><span>Dress</span>&nbsp;<span>(23)</span></a></li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="widget-featured-products mb_36">
                                    <div class="featured-product-item">
                                        <a href="product-detail.html" class="card-product-wrapper">
                                            <img class="lazyload img-product" data-src="/user/images/products/img-feature-1.png" alt="image-feature">
                                        </a>
                                        <div class="card-product-info">
                                            <a href="shop-right-sidebar.html#" class="title link">Jersey thong body</a>
                                            <span class="price">$105.95</span>
                                        </div>
                                    </div>
                                    <div class="featured-product-item">
                                        <a href="product-detail.html" class="card-product-wrapper">
                                            <img class="lazyload img-product" data-src="/user/images/products/img-feature-2.png" alt="image-feature">
                                        </a>
                                        <div class="card-product-info">
                                            <a href="shop-right-sidebar.html#" class="title link">Lace-trimmed Satin Camisole Top</a>
                                            <span class="price">€24,95</span>
                                        </div>
                                    </div>
                                    <div class="featured-product-item">
                                        <a href="product-detail.html" class="card-product-wrapper">
                                            <img class="lazyload img-product" data-src="/user/images/products/img-feature-3.png" alt="image-feature">
                                        </a>
                                        <div class="card-product-info">
                                            <a href="shop-right-sidebar.html#" class="title link">Linen-blend Tank Top</a>
                            ...
                            <div id="gallery" class="collapse show">
                                <div class="grid-3 gap-4 mb_36">
                                    <a href="product-detail.html" class="item-gallery">
                                        <img class="lazyload" data-src="/user/images/shop/gallery/gallery-1.jpg" alt="img-gallery">
                                    </a>
                                    <a href="product-detail.html" class="item-gallery">
                                        <img class="lazyload" data-src="/user/images/shop/gallery/gallery-2.jpg" alt="img-gallery">
                                    </a>
                                    <a href="product-detail.html" class="item-gallery">
                                        <img class="lazyload" data-src="/user/images/shop/gallery/gallery-3.jpg" src="/user/images/shop/gallery/gallery-3.jpg" alt="img-gallery">
                                    </a>
                                    <a href="product-detail.html" class="item-gallery">
                                        <img class="lazyload" data-src="/user/images/shop/gallery/gallery-4.jpg" alt="img-gallery">
                                    </a>
                                    <a href="product-detail.html" class="item-gallery">
                                        <img class="lazyload" data-src="/user/images/shop/gallery/gallery-5.jpg" src="/user/images/shop/gallery/gallery-5.jpg" alt="img-gallery">
                                    </a>
                                    <a href="product-detail.html" class="item-gallery">
                                        <img class="lazyload" data-src="/user/images/shop/gallery/gallery-6.jpg" src="/user/images/shop/gallery/gallery-6.jpg" alt="img-gallery">
                                    </a>
                        ...
                        <div class="widget-facet">
                            ...
                            <div id="follow" class="collapse show">
                                <ul class="tf-social-icon d-flex gap-10">
                                    <li><a href="shop-right-sidebar.html#" class="box-icon w_34 round bg_line social-facebook"><i class="icon fs-14 icon-fb"></i></a></li>
                                    <li><a href="shop-right-sidebar.html#" class="box-icon w_34 round bg_line social-twiter"><i class="icon fs-12 icon-Icon-x"></i></a></li>
                                    <li><a href="shop-right-sidebar.html#" class="box-icon w_34 round bg_line social-instagram"><i class="icon fs-14 icon-instagram"></i></a></li>
                                    <li><a href="shop-right-sidebar.html#" class="box-icon w_34 round bg_line social-tiktok"><i class="icon fs-14 icon-tiktok"></i></a></li>
                                    <li><a href="shop-right-sidebar.html#" class="box-icon w_34 round bg_line social-pinterest"><i class="icon fs-14 icon-pinterest-1"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </aside>
