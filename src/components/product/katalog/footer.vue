                        ...
                        <div class="col-xl-3 col-md-6 col-12">
                            <div class="footer-infor">
                                <div class="footer-logo">
                                    <a href="index.html">
                                        <img src="/user/images/logo/logo.svg" alt="">
                                    </a>
                                </div>
                                <ul>
                                    <li>
                                    ...
                                    <li>
                                        <p>Email: <a href="shop-right-sidebar.html#">info@fashionshop.com</a></p>
                                    </li>
                                    <li>
                                        <p>Phone: <a href="shop-right-sidebar.html#">(212) 555-1234</a></p>
                                    </li>
                                </ul>
