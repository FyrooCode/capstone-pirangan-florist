        ...
        <div class="wrapper-control-shop tf-shop-content">
            ...
            <div class="tf-list-layout wrapper-shop" id="listLayout">
                ...
                <div class="card-product list-layout" data-availability="In stock" data-brand="Ecomus">
                    <div class="card-product-wrapper">
                        <a href="shop-right-sidebar.html#" class="product-img">
                            <img class="lazyload img-product" data-src="/user/images/products/orange-1.jpg"
                                src="/user/images/products/orange-1.jpg" alt="image-product">
                            <img class="lazyload img-hover" data-src="/user/images/products/white-1.jpg"
                                src="/user/images/products/white-1.jpg" alt="image-product">
                        </a>
                    </div>
                    <div class="card-product-info">
                        <a href="shop-right-sidebar.html#" class="title link">Ribbed Tank Top</a>
                        <span class="price current-price">$16.95</span>
                        <p class="description">Button-up shirt sleeves and a relaxed silhouette. It’s tailored with
                            drapey, crinkle-texture fabric that’s made from LENZING™ ECOVERO™ Viscose — responsibly
                            sourced wood-based fibres produced through a process that reduces...</p>
                        <ul class="list-color-product">
                            <li class="list-color-item hover-tooltip color-swatch active">
                                <span class="tooltip tooltip-bottom">Orange</span>
                                <span class="swatch-value bg_orange-3"></span>
                                <img class="lazyload" data-src="/user/images/products/orange-1.jpg"
                                    src="/user/images/products/orange-1.jpg" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">Black</span>
                                <span class="swatch-value bg_dark"></span>
                                <img class="lazyload" data-src="/user/images/products/black-1.jpg"
                                    src="/user/images/products/black-1.jpg" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">White</span>
                                <span class="swatch-value bg_white"></span>
                                <img class="lazyload" data-src="/user/images/products/white-1.jpg"
                                    src="/user/images/products/white-1.jpg" alt="image-product">
                            </li>
                        </ul>
                        <div class="size-list">
                        ...
                        <div class="list-product-btn">
                            <a href="shop-right-sidebar.html#quick_add" data-bs-toggle="modal"
                                class="box-icon quick-add style-3 hover-tooltip"><span
                                    class="icon icon-bag"></span><span class="tooltip">Quick add</span></a>
                            <a href="shop-right-sidebar.html#" class="box-icon wishlist style-3 hover-tooltip"><span
                                    class="icon icon-heart"></span> <span class="tooltip">Add to Wishlist</span></a>
                            <a href="shop-right-sidebar.html#compare" data-bs-toggle="offcanvas"
                                class="box-icon compare style-3 hover-tooltip"><span class="icon icon-compare"></span>
                                <span class="tooltip">Add to Compare</span></a>
                            <a href="shop-right-sidebar.html#quick_view" data-bs-toggle="modal"
                ...
                <div class="card-product list-layout" data-availability="In stock" data-brand="Ecomus">
                    <div class="card-product-wrapper">
                        <div class="product-img">
                            <img class="lazyload img-product" data-src="/user/images/products/brown.jpg"
                                src="/user/images/products/brown.jpg" alt="image-product">
                            <img class="lazyload img-hover" data-src="/user/images/products/purple.jpg"
                                src="/user/images/products/purple.jpg" alt="image-product">
                        </div>
                    ...
                    <div class="card-product-info">
                        ...
                        <ul class="list-color-product">
                            <li class="list-color-item color-swatch active">
                                ...
                                <img class="lazyload" data-src="/user/images/products/brown.jpg"
                                    src="/user/images/products/brown.jpg" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">Light Purple</span>
                                <span class="swatch-value bg_purple"></span>
                                <img class="lazyload" data-src="/user/images/products/purple.jpg"
                                    src="/user/images/products/purple.jpg" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">Light Green</span>
                                <span class="swatch-value bg_light-green"></span>
                                <img class="lazyload" data-src="/user/images/products/green.jpg"
                                    src="/user/images/products/green.jpg" alt="image-product">
                            </li>
                        </ul>
                        <div class="size-list">
                            <span class="size-item">S</span>
                        ...
                        <div class="list-product-btn">
                            <a href="shop-right-sidebar.html#quick_add" data-bs-toggle="modal"
                                class="box-icon quick-add style-3"><span class="icon icon-bag"></span><span
                                    class="tooltip">Quick add</span></a>
                            <a href="shop-right-sidebar.html#" class="box-icon wishlist style-3"><span
                                    class="icon icon-heart"></span> <span class="tooltip">Add to Wishlist</span></a>
                            <a href="shop-right-sidebar.html#compare" data-bs-toggle="offcanvas"
                                class="box-icon compare style-3"><span class="icon icon-compare"></span> <span
                                    class="tooltip">Add to Compare</span></a>
                            <a href="shop-right-sidebar.html#quick_view" data-bs-toggle="modal"
                ...
                <div class="card-product list-layout" data-availability="In stock" data-brand="Ecomus">
                    <div class="card-product-wrapper">
                        <div class="product-img">
                            <img class="lazyload img-product" data-src="/user/images/products/white-3.jpg"
                                src="/user/images/products/white-3.jpg" alt="image-product">
                            <img class="lazyload img-hover" data-src="/user/images/products/white-4.jpg"
                                src="/user/images/products/white-4.jpg" alt="image-product">
                        </div>
                    </div>
                    <div class="card-product-info">
                ...
                <div class="card-product list-layout" data-availability="In stock" data-brand="Ecomus">
                    <div class="card-product-wrapper">
                        <div class="product-img">
                            <img class="lazyload img-product" data-src="/user/images/products/white-2.jpg"
                                src="/user/images/products/white-2.jpg" alt="image-product">
                            <img class="lazyload img-hover" data-src="/user/images/products/pink-1.jpg"
                                src="/user/images/products/pink-1.jpg" alt="image-product">
                        </div>
                    </div>
                    <div class="card-product-info">
                        <a href="shop-right-sidebar.html#" class="title link">Oversized Printed T-shirt</a>
                        ...
                        <ul class="list-color-product">
                            <li class="list-color-item color-swatch active">
                                <span class="tooltip">White</span>
                                <span class="swatch-value bg_white"></span>
                                <img class="lazyload" data-src="/user/images/products/white-2.jpg"
                                    src="/user/images/products/white-2.jpg" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">Pink</span>
                                <span class="swatch-value bg_purple"></span>
                                <img class="lazyload" data-src="/user/images/products/pink-1.jpg"
                                    src="/user/images/products/pink-1.jpg" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">Black</span>
                                <span class="swatch-value bg_dark"></span>
                                <img class="lazyload" data-src="/user/images/products/black-2.jpg"
                                    src="/user/images/products/black-2.jpg" alt="image-product">
                            </li>
                        </ul>
                        <div class="size-list">
                            <span class="size-item">S</span>
            ...
            <div class="tf-grid-layout wrapper-shop tf-col-3" id="gridLayout">
                ...
                <div class="card-product grid" data-availability="In stock" data-brand="Ecomus">
                    <div class="card-product-wrapper">
                        ...
                        <div class="list-product-btn absolute-2">
                            ...
                            <a href="shop-right-sidebar.html#compare" data-bs-toggle="offcanvas"
                                aria-controls="offcanvasLeft" class="box-icon bg_white compare btn-icon-action">
                ...
                <div class="card-product grid" data-availability="In stock" data-brand="Ecomus">
                    <div class="card-product-wrapper">
                        ...
                        <div class="list-product-btn absolute-2">
                            <a href="shop-right-sidebar.html#shoppingCart" data-bs-toggle="modal"
                                class="box-icon bg_white quick-add tf-btn-loading">
                                <span class="icon icon-bag"></span>
                ...
                <div id="categories" class="collapse show">
                    <ul class="list-categoris current-scrollbar mb_36">
                        <li class="cate-item current"><a
                                href="shop-right-sidebar.html#"><span>Fashion</span>&nbsp;<span>(31)</span></a></li>
                        <li class="cate-item"><a
                                href="shop-right-sidebar.html#"><span>Men</span>&nbsp;<span>(9)</span></a></li>
                        <li class="cate-item"><a
                                href="shop-right-sidebar.html#"><span>Women</span>&nbsp;<span>(23)</span></a></li>
                        <li class="cate-item"><a
                                href="shop-right-sidebar.html#"><span>Denim</span>&nbsp;<span>(20)</span></a></li>
                        <li class="cate-item"><a
                                href="shop-right-sidebar.html#"><span>Dress</span>&nbsp;<span>(23)</span></a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="widget-facet">
                ...
                <div id="follow" class="collapse show">
                    <ul class="tf-social-icon d-flex gap-10">
                        <li><a href="shop-right-sidebar.html#" class="box-icon w_34 round bg_line social-facebook"><i
                                    class="icon fs-14 icon-fb"></i></a></li>
                        <li><a href="shop-right-sidebar.html#" class="box-icon w_34 round bg_line social-twiter"><i
                                    class="icon fs-12 icon-Icon-x"></i></a></li>
                        <li><a href="shop-right-sidebar.html#" class="box-icon w_34 round bg_line social-instagram"><i
                                    class="icon fs-14 icon-instagram"></i></a></li>
                        <li><a href="shop-right-sidebar.html#" class="box-icon w_34 round bg_line social-tiktok"><i
                                    class="icon fs-14 icon-tiktok"></i></a></li>
                        <li><a href="shop-right-sidebar.html#" class="box-icon w_34 round bg_line social-pinterest"><i
