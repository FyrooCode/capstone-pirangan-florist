    ...
    <div class="section-menu-left">
        <div class="box-logo">
            <a href="index.html" id="site-logo-inner">
                <img class="" id="logo_header" alt="" src="/user/images/logo/logo.svg"
                    data-light="/user/images/logo/logo.svg" data-dark="/user/images/logo/logo-white.svg">
            </a>
        ...
        <div class="header-dashboard">
            <div class="wrap">
                <div class="header-left">
                    <a href="index.html">
                        <img class="" id="logo_header_mobile" alt="" src="/user/images/logo/logo.svg"
                            data-light="/user/images/logo/logo.svg" data-dark="/user/images/logo/logo-white.svg">
                    </a>
                    <div class="button-show-hide">
                        <i class="icon-chevron-left"></i>
                                ...
                                <ul class="flex flex-column h-full has-divider-line">
                                    <li class="wg-product">
                                        <div class="name flex-grow">
                                            ...
                                            <div>
                                                <div class="title">
                                                    <a href="index.html#" class="body-text">Neptune
                                                        Longsleeve</a>
                                                </div>
                                    ...
                                    <li class="wg-product">
                                        <div class="name flex-grow">
                                            ...
                                            <div>
                                                <div class="title">
                                                    <a href="index.html#" class="body-text">Ribbed Tank
                                                        Top</a>
                                                </div>
                                    ...
                                    <li class="wg-product">
                                        <div class="name flex-grow">
                                            ...
                                            <div>
                                                <div class="title">
                                                    <a href="index.html#" class="body-text">Ribbed modal
                                                        T-shirt</a>
                                                </div>
                                    ...
                                    <li class="wg-product">
                                        <div class="name flex-grow">
                                            ...
                                            <div>
                                                <div class="title">
                                                    <a href="index.html#" class="body-text">Oversized Motif
                                                        T-shirt</a>
                                                </div>
                                    ...
                                    <li class="wg-product">
                                        <div class="name flex-grow">
                                            ...
                                            <div>
                                                <div class="title">
                                                    <a href="index.html#" class="body-text">V-neck linen
                                                        T-shirt</a>
                                                </div>
                                    ...
                                    <li class="wg-product">
                                        <div class="name flex-grow">
                                            ...
                                            <div>
                                                <div class="title">
                                                    <a href="index.html#" class="body-text">Jersey thong
                                                        body</a>
                                                </div>
